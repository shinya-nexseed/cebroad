...
<!-- スライドショー -->
		<link rel="stylesheet" href="webroot/assets/css/jquery.bxslider.css">
		<script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js" /></script>
		<script src="webroot/assets/js/jquery.bxslider.min.js"></script>
		<script>
			$(function(){
			$('.bxslider').bxSlider({
				auto: true,
...
<body>
  index.php通過
	    <div id="top" class="bxslider navbar navbar-inverse" role="navigation">
	    <div class="overlay">
			<div class="container">
