...
if (count($errors) === 0){
	...
	$url = "http://cebroad.sakura.ne.jp/mailto-master/registration_form.php"."?urltoken=".$urltoken;
	...
	try{
		...
		$statement = $dbh->prepare("INSERT INTO pre_member (urltoken,mail,created) VALUES (:urltoken,:mail,now() )");
		//プレースホルダへ実際の値を設定する
